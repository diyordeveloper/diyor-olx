...
import { Xizmatlar } from "../../../Contexts/ArrCatories";
function Xizmat() {
  ...
  return (
    <div className="col-12">
      <h2 className="text-center">Xizmatlar </h2>
      <h5 className="text-center">
        Hozircha faqat xizmatlar e'lon bera olasiz
      </h5>
      <form
        id="addformXizmatlar"
      ...
      >
        ...
        <button className="btn btn-success mt-4" form="addformXizmatlar">
