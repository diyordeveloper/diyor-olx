...
import { Elektrjihozlari } from "../../../Contexts/ArrCatories";
function Elektrajihozchik() {
  ...
  const onSubmitForm = (e) => {
    ...
    if (sarlavha !== "") {
      const uploadTask = storage
        .ref(
          `Elektrjihozlari/${user?.name + " - " + user?.phone + " - " + user?.uid}/${
            images.name
          }`
        )
        .put(images);
  ...
  return (
    <div className="col-12">
      <h2 className="text-center">Elektr jihozlari </h2>
      <h5 className="text-center">
        Hozircha faqat Elektr jihozlari e'lon bera olasiz
      </h5>
      <form
        id="addformElektrjihozlari"
      ...
      >
        ...
        <div className="mt-4">
          <label htmlFor="turi">Markasi*</label>
          <input
            type={"text"}
        ...
        <button className="btn btn-success mt-4" form="addformElektrjihozlari">
...
export default Elektrajihozchik;
