...
import { Xobbisport } from "../../../Contexts/ArrCatories";
function XobbiDamOlish() {
  ...
  return (
    <div className="col-12">
      <h2 className="text-center">Xobbi dam olish,sport</h2>
      <h5 className="text-center">
        Hozircha faqat xobbi dam olish , sport buyumlarini e'lon bera olasiz
      </h5>
      <form
        id="addformXobbisport"
      ...
      >
        ...
        <button className="btn btn-success mt-4" form="addformXobbisport">
