...
import { Uyvabog } from "../../../Contexts/ArrCatories";
function UyBog() {
  ...
  const [mebelTuri, setMebelTuri] = useState("");
  const [qaysiXonaUchun, setQaysiXonaUchun] = useState("");
  ...
  return (
    <div className="col-12">
      <h2 className="text-center">Uy va Bog'</h2>
      <h5 className="text-center">
        Hozircha faqat uy uchun mebellar e'lon bera olasiz
      </h5>
      <form
        id="addformUyvaBog"
      ...
      >
        ...
        <div className="mt-4">
          <label htmlFor="turi">Mebel qaysi xona uchun*</label>
          <input
            type={"text"}
            onChange={(e) => setQaysiXonaUchun(e.target.value)}
            value={qaysiXonaUchun}
            id="turi"
            className="form-control mt-2"
        ...
        <div className="mt-4">
          <label htmlFor="turi">Mebel turi*</label>
          <select
            onChange={(e) => setMebelTuri(e.target.value)}
            className="form-select form-select"
            aria-label="form-select example"
            id="holati"
            required
          >
            ...
            <option value="Shkaflar / stenkalar">Shkaflar / stenkalar</option>
            <option value="Stollar / stullar">Stollar / stullar</option>
            <option value="Mehmonxona uchun boshqa mebel">
              Mehmonxona uchun boshqa mebel
            </option>
          </select>
        </div>
        ...
        <button className="btn btn-success mt-4" form="addformUyvaBog">
